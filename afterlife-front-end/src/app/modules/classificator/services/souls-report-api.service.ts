...
export class SoulsReportApiService {
  ...
  public setSinsReport(csvSinsReport: string) {
    return this.http.put(this.apiUrl,csvSinsReport)
  }
  public setGoodnessReport(csvGoodnessReport: string) {
    return this.http.put(this.apiUrl,csvGoodnessReport)
  }
}
